...
--- @return data.Sprite4Way The sprites for the constant combinator.
...
--- @return data.IconData[] The icons for the constant combinator.
function constant_combinator.icons_from_tint(main_color)
  if not main_color then error("Missing required argument 'main_color'", 2) end
  main_color = util.premul_color(main_color)

  return {
    {icon = "__khaosbash__/graphics/base/icons/constant-combinator-base.png", icon_size = 64},
    {icon = "__khaosbash__/graphics/base/icons/constant-combinator-mask-main-color.png", icon_size = 64, tint = main_color},
  }
end
